...
<html lang="es">
    <?php
    $ruta = "../../..";
    $titulo = "Aplicación de ventas - Filtrar empleado";
    ...
    <div class="container-fluid d-flex">
        ...
        <div class="container mt-3">
            <header>
                <h1><i class="fas fa-filter"></i> Filtrar Empleado</h1>
                <hr/>
            </header>
                ...
                <article>
                    <div class="row justify-content-center mt-3">
                        <div class="card col-md-5">
                                <form id="frm_filtrar_emp" name="frm_filtrar_emp" method="post">
                                    <div class="input-group mb-3">
                                        ...
                                        <a class="btn btn-outline-primary" href="filtrar_empleado.php">Nuevo</a>
                                    </div>
                                </form>
                        </div>
                    </div>
