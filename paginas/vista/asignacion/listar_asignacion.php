...
<html lang="es">
    <?php
        $ruta="../../..";
        $titulo="Aplicación de Ventas - Lista de Asignaciones";
    ...
    <div class="container-fluid d-flex">
        <?php
            ...
            $rs_asi = $crudasignacion->ListarAsignacion();
        ?>
        <div class="flex-grow-1 p-4">
            <div class="container mt-3">
                <header>
                    <h1>
                    <i class="fa-solid fa-rectangle-list fa-shake"></i> Lista de Asignaciones
                    </h1>
                    <hr/>
                </header>
            </div>
            <nav class="d-flex justify-content-center">
                <div class="btn-group col-md-5" role="group">
                    <a href="registrar_asignacion.php" class="btn btn-primary">
                        <i class="fas fa-plus-circle"></i> Registrar
                    </a>
                    <a href="consultar_asignacion.php" class="btn btn-primary">
                        <i class="fas fa-search"></i> Consultar
                    </a>
                    <a href="filtrar_asignacion.php" class="btn btn-primary">
                    ...
                    <div class="row justify-content-center mt-3">
                        <div class="col-md-10">
                            <div class="table-responsive">
                                <table id="tablaAsignaciones" class="table table-striped table-hover text-center">
                                    ...
                                    <tbody id="tablaBody">
                                        <?php
                                            $i = 0;
                                            foreach ($rs_asi as $asi) {
                                                $i++;
                                        ?>
                                        <tr class="reg_asignacion">
                                            <td><?= $i ?></td>
                                            <td class="codasi"><?= $asi->codigo_asignacion ?></td>
                                            <td class="f_asi"><?= $asi->fecha_asignacion ?></td>
                                            <td class="rol"><?= $asi->rol ?></td>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title text-danger" id="staticBackdropLabel"><i class="fa-solid fa-trash-can fa-bounce"></i> Borrar Asignación</h4>
                        ...
                        <div class="modal-body">
                            <div class="row justify-content-center">
                                ...
                                <p class="card-text">
                                    <span class="lbl_rol"></span> (<span class="lbl_codasi"></span>)
                                </p>
                            </div>
                        </div>
