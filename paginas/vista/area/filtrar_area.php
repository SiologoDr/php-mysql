...
<html lang="es">
    <?php
    $ruta = "../../..";
    $titulo = "Aplicación de ventas - Filtrar Área";
    ...
    <div class="container-fluid d-flex">
        ...
        <div class="container mt-3">
            <header>
                <h1><i class="fas fa-filter"></i> Filtrar Área</h1>
                <hr/>
            </header>
                ...
                <article>
                    <div class="row justify-content-center mt-3">
                        <div class="card col-md-5">
                            <form id="frm_filtrar_area" name="frm_filtrar_area" method="post">
                                <div class="input-group mb-3">
                                    ...
                                    <a class="btn btn-outline-primary" href="filtrar_area.php">Nuevo</a>
                                </div>
                            </form>
                        </div>
                    </div>
